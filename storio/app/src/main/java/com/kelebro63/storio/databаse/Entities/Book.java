...
public class Book {
    ...
    @NonNull
    public static Book newBook(@Nullable Long id, @NonNull String author, @NonNull String content) {
        return new Book(id, author, content);
    }

    @NonNull
    public static Book newBook(@NonNull String author, @NonNull String content) {
